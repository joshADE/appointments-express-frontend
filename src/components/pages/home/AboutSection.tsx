        ...
        return (
            <section id="about" className="font-roboto">
                <div className="py-20 mx-auto container px-10 overflow-hidden">
                    ...
                    <h2 className="text-center font-extrabold text-4xl">What does the app do?</h2>
                    <h2 className="text-center font-extrabold text-4xl">And what is it for?</h2>
                    <div className="flex flex-col md:flex-row mt-20 justify-around items-center">
                        ...
                        <ul className="list-disc font-semibold md:w-1/2 p-10">
                            <li className="mb-5">
