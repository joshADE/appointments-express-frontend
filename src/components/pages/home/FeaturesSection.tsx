...
const featureList = [
    ...
    { title: 'Quick Profiles', desc: 'Easily setup a store based on predefined profile with fields that you can selectively include', icon: <MdIcons.MdCheckBox />, image: image2}
]
        ...
        return (
            <section id="features" className="font-roboto">
                <div className="py-20 mx-auto container px-10 overflow-hidden">
                    ...
                    <h2 className="font-extrabold text-4xl md:w-3/5 text-center md:text-left">Supports many feautures that you would expect from a regular appointment scheduler and more</h2>
                        ...
                        <div className="flex lg:w-1/2 flex-col" ref={feautureContainerRef}>
                            ...
                            >
                                ...
                                <div className="text-left">
                                    <h5 className="text-2xl font-extrabold">{feature.title}</h5>
                                    <h6 className="text-lg text-gray-500">{feature.desc}</h6>
                                </div>
                            </button>)}
                        </div>
                        <img className="max-w-lg object-contain" src={selectedFeatureIndex === -1 ? defaultImage: featureList[selectedFeatureIndex].image} alt="screenshot of app" /> 
                    </div>
                </div>
            </section>
        );
